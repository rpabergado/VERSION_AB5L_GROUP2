<!-- 
   File: app/View/Layouts/admin_default.ctp 
-->
					...
					<div class="navbar navbar-inverse">
						...
						<div class="nav-collapse">
							...
							<ul class="nav" id="navigation_links">
								...
								<li>
									<a href="viewtransactions"><i class="icon-credit-card icon-large"></i> Transactions </a>
								</li>

								<li class="divider-vertical"></li>
								<li>
									<a href="manageproducts"><i class="icon-medkit icon-large"></i> Products </a>
								</li>

								<li class="divider-vertical"></li>

								<li><a href="managecoupons"><i class="icon-tags icon-large"></i> Coupons </a>
								</li>

								<li class="divider-vertical"></li>

								<li><a href="viewsummary"><i class="icon-bar-chart icon-large"></i> Summary </a>
								</li>
							</ul>
